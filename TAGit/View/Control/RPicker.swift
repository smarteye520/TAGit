...
class RToolBar: UIView {
    ...
    open var toolbar: UIToolbar {
        ...
        let toolBarTitleItem = toolBarL.titleItem(text: "", font: UIFont.regular(size: 17), color: UIColor.white)
        
        self.toolBarTitleItem = toolBarTitleItem as? ToolBarTitleItem
        toolBarL.appendButton(buttonItem: toolBarTitleItem)
        toolBarL.appendButton(buttonItem: toolBarL.flexibleSpace)
        toolBarL.appendButton(buttonItem: toolBarL.buttonItem(systemItem: .save, selector: #selector(self.doneAction)))
...
class ToolBar: UIToolbar {
    ...
    init(frame: CGRect, target: Any?) {
        ...
        self.barTintColor = UIColor.appBlue
    }
